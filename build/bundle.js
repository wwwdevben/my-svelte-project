var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			attr(div0, "class", "progress-bar svelte-1hoy6gw");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1hoy6gw");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-z7jh4e");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-z7jh4e");
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" img="" src="handwashing.jpg" alt="How to wash your hands." class="svelte-1ghtied"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Image Attribution</a> 
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Attribution</a>`;

    			attr(h1, "class", "svelte-1tu873s");
    			attr(h3, "class", "svelte-1tu873s");
    		},
    		m(target, anchor) {
